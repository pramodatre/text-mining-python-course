...
class DocStats:
    ...
    def get_document_ids(self):
        return list(self.document_tfidf_map.keys())
    ...
    def document_terms_lookup(self, docs: list) -> dict:
        document_terms_map = {}
        for doc_id, doc in enumerate(docs):
            terms = TextPreProcessor(doc).get_tokens()
    ...
    def inverse_document_frequency(self, term: str) -> float:
        ...
        return np.log(total_docs / ((len(docs_containing_term)) + 1)) + 1
...
if __name__ == "__main__":
    docs = [
        ...
        "investigation of the effects of ground proximity and propeller position on the effectiveness of a wing with large chord slotted flaps in redirecting propeller slipstream downward for vertical take-off .",
